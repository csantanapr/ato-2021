...
curl -sL https://raw.githubusercontent.com/csantanapr/knative-kind/knative-nightly/02-serving.sh | bash
echo -e "🔌 Installing Knative Serving Networking Layer ${KNATIVE_NET}... \033[0m"
if [[ "$KNATIVE_NET" == "kourier" ]]; then
    curl -sL https://raw.githubusercontent.com/csantanapr/knative-kind/knative-nightly/02-kourier.sh | bash
else
    curl -sL https://raw.githubusercontent.com/csantanapr/knative-kind/knative-nightly/02-contour.sh | bash
fi
